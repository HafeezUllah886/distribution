        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="d-flex breadcrumb-content">
                <div class="page-header">
                    <div class="page-title"><h3>Transfer</h3></div>
                </div>
            </div>
        ...
        <table id="html5-extension" class="table dt-table-hover" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $tran->refID }}</td>
                    <td>{{ $tran->date }}</td>
                    <td>{{ $tran->fromAccount->name }}</td>
                    <td>{{ $tran->toAccount->name }}</td>
                    <td>{{ $tran->notes }}</td>
                    <td>{{ $tran->amount }}</td>
                    <td class="text-center d-flex justify-content-center align-items-center">
                        <a href="{{ url('/transfer/delete/') }}/{{ $tran->refID }}" class="text-danger"><i class="fa fa-trash">Delete</i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
